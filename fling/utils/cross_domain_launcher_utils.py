...
def _client_trainer(client: CrossDomainClientTemplate, kwargs: dict) -> Tuple:
...
def _client_tester(client: CrossDomainClientTemplate, kwargs: dict) -> Tuple:
...
def _client_finetuner(client: CrossDomainClientTemplate, kwargs: dict) -> Tuple:
...
class SerialLauncher:
    ...
    def launch(self, clients: CrossDomainClientTemplate, task_name: str, **kwargs) -> List:
        r"""
        Overview:
...
def get_cross_domain_launcher(args: dict) -> object:
    r"""
    Overview:
