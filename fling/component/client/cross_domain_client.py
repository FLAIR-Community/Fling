...
class CrossDomainClient(ClientTemplate):
    """
    Overview:
    ...
    def __init__(self, args: dict, domain: str, client_id: int, train_dataset: Dataset, test_dataset: Dataset = None):
        ...
        Arguments:
            ...
            - domain: Used to indicate the domain origin of the clients.
            - client_id: Used to index among clients within the same domain.
        Returns:
            - None
        """
