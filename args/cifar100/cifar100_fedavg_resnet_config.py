...
def args_parser():
    ...
    parser.add_argument('--class_number', type=int, default=100, help='class channel')
    ...
    parser.add_argument('--logging_path', type=str, default='./logging/cifar100_resnet_cifar_avg_iid', help='logging path')
