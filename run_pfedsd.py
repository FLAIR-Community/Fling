...
def main():
    # cifar10
    from argzoo.cifar10.cifar10_pfedsd_resnet_config import exp_args
    launch_diri(algo_name='pfedsd', dataset_name='cifar10', base_args=exp_args, alphas=[0.1, 0.5, 1.0])
    launch_patho(algo_name='pfedsd', dataset_name='cifar10', base_args=exp_args, alphas=[2])

    # cifar100
    from argzoo.cifar100.cifar100_pfedsd_resnet_config import exp_args
    launch_diri(algo_name='pfedsd', dataset_name='cifar100', base_args=exp_args, alphas=[0.1, 0.5, 1.0])
    launch_patho(algo_name='pfedsd', dataset_name='cifar100', base_args=exp_args, alphas=[2])

    # tiny
    from argzoo.imagenet_tiny.tiny_imagenet_pfedsd_resnet_config import exp_args
